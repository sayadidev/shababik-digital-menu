  ...
  return (
    <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-4 md:space-y-5 animate-pulse">
      <div className="flex items-center justify-between">
        <div className="h-5 w-32 bg-muted/30 rounded-lg" />
        <div className="h-9 w-28 bg-muted/20 rounded-xl" />
      </div>
              ...
              <tr className="border-b border-border">
                {[1, 2, 3, 4, 5].map((i) => (
                  <th key={i} className="px-5 py-3">
                    <div className="h-3 w-14 bg-muted/20 rounded-full" />
                  </th>
                ))}
              </tr>
            </thead>
        ...
        <div className="md:hidden divide-y divide-border/50">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="px-4 py-3 space-y-2">
              <div className="flex items-center justify-between">
                <div>
                  <div className="h-4 w-28 bg-muted/30 rounded-full mb-1" />
                  <div className="h-3 w-20 bg-muted/20 rounded-full" />
                </div>
                <div className="h-6 w-14 bg-muted/20 rounded-full" />
              </div>
              <div className="h-3 w-36 bg-muted/20 rounded-full" />
              <div className="flex gap-2">
                <div className="h-5 w-10 bg-muted/20 rounded" />
